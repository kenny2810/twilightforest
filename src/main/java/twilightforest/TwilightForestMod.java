...
@Mod( modid = TwilightForestMod.ID,
		...
		dependencies = "after:ctm@[MC1.12.2-0.3.2.18,);before:immersiveengineering@[0.12-83,);before:tconstruct;required-after:forge@[14.23.4.2767,);after:thaumcraft@[6.1.BETA21,)",
